...
public class DatosEstructurados {
	public static void main(String[] args) {
		 ...
		 * -- Variables dinámicas. Son aquellas que se declaran con un valor pero que dicho valor puee cambiar durante el proceso.
		...
		System.out.println("Ahora mis gastos mensuales ascienden  " + gastosMensuales);
